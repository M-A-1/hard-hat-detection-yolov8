...
The main trained model committed to the repository is:
...
The repository also contains the captured training/evaluation outputs (`results.csv`, `results.png`, confusion matrices, and `labels.jpg`) plus the submitted detection, segmentation, and real-world tracking evidence.
